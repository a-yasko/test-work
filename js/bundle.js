...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _zero__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30);
/* harmony import */ var _info_payment_render_modal_info__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(31);
/* harmony import */ var _check_amount__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32);
...
function render(data) {
  ...
  data.forEach(item => {
    ...
    trForTbody.innerHTML = `
      <tr>
        <td>${item.orderid}</td>
        <td>${yyyy}-${(0,_zero__WEBPACK_IMPORTED_MODULE_0__.default)(mm)}-${(0,_zero__WEBPACK_IMPORTED_MODULE_0__.default)(dd)} ${(0,_zero__WEBPACK_IMPORTED_MODULE_0__.default)(hours)}:${(0,_zero__WEBPACK_IMPORTED_MODULE_0__.default)(minutes)}</td>
        <td>${(0,_check_amount__WEBPACK_IMPORTED_MODULE_2__.default)(item.amount)}</td>
        <td>${item.cardmask}</td>
      </tr>
    `;
    ...
    trForTbody.addEventListener('mouseup', event => {
      ...
      if (x1 === x2 && y1 === y2) {
        ...
        (0,_info_payment_render_modal_info__WEBPACK_IMPORTED_MODULE_1__.default)(trForTbody.getAttribute('data-id'));
      }
    });
  });
}
...
/* harmony default export */ __webpack_exports__["default"] = (plusZero);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_get_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _table_check_amount__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32);
...
async function renderModalInfo(id) {
  ...
  const data = await (0,_services_get_data__WEBPACK_IMPORTED_MODULE_0__.default)(`http://localhost:3000/payments/${id}`);
  ...
  for (const item in data) {
    ...
    if (item === 'amount') {
      head = 'Сумма';
      value = (0,_table_check_amount__WEBPACK_IMPORTED_MODULE_1__.default)(value);
    }
...
/* harmony default export */ __webpack_exports__["default"] = (renderModalInfo);
...
/* harmony default export */ __webpack_exports__["default"] = (checkAmount);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _table_render_rows__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29);
...
function sort(data) {
  ...
  function sortCol(name) {
    if (count === 0) {
      (0,_table_render_rows__WEBPACK_IMPORTED_MODULE_0__.default)(data.sort((a, b) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _create_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(36);
/* harmony import */ var _validation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(37);



function addPayment() {
  (0,_create_modal__WEBPACK_IMPORTED_MODULE_0__.default)();
  (0,_validation__WEBPACK_IMPORTED_MODULE_1__.default)();
}

/* harmony default export */ __webpack_exports__["default"] = (addPayment);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _table_zero__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30);


function createModalAddPayment() {
  const now = `${new Date().getUTCFullYear()}-${(0,_table_zero__WEBPACK_IMPORTED_MODULE_0__.default)(new Date().getMonth() + 1)}-${(0,_table_zero__WEBPACK_IMPORTED_MODULE_0__.default)(new Date().getDate())}T${(0,_table_zero__WEBPACK_IMPORTED_MODULE_0__.default)(new Date().getHours())}:${(0,_table_zero__WEBPACK_IMPORTED_MODULE_0__.default)(new Date().getMinutes())}`;
  const app = document.querySelector('.app');
...
/* harmony default export */ __webpack_exports__["default"] = (createModalAddPayment);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_post_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38);
/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39);
/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(inputmask__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _table_zero__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30);
...
function validation() {
  ...
  orderid.addEventListener('blur', event => {
    event.target.value = event.target.value.replace(/\-+/gi, '-').replace(/^\-/gi, '').replace(/\-$/gi, '');
  });
  ...
  btn.addEventListener('click', event => {
    ...
    if (inputs[0].value.trim() && inputs[1].value.trim() && inputs[2].value.trim() && inputs[3].value.trim() && objIsValid.isValidAmount && objIsValid.isValidCardmask) {
      (0,_services_post_data__WEBPACK_IMPORTED_MODULE_0__.default)({
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _get_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
/* harmony import */ var _modules_table_render_rows__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(29);
/* harmony import */ var _modules_sort_sort__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(34);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_delete_payment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41);
...
/* harmony default export */ __webpack_exports__["default"] = (createModalInfo);
...
/* harmony default export */ __webpack_exports__["default"] = (deletePayment);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_get_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _modules_table_render_rows__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29);
/* harmony import */ var _modules_table_render_table__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(33);
/* harmony import */ var _modules_sort_sort__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(34);
/* harmony import */ var _modules_add_payment_add_payment__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35);
/* harmony import */ var _modules_info_payment_create_modal_info__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(40);
...
document.addEventListener('DOMContentLoaded', () => {
  async function app() {
    const reqPayments = await (0,_services_get_data__WEBPACK_IMPORTED_MODULE_0__.default)('http://localhost:3000/payments');
    const reqHeads = await (0,_services_get_data__WEBPACK_IMPORTED_MODULE_0__.default)('http://localhost:3000/theads');
    (0,_modules_table_render_table__WEBPACK_IMPORTED_MODULE_2__.default)(reqHeads);
    (0,_modules_table_render_rows__WEBPACK_IMPORTED_MODULE_1__.default)(reqPayments);
    (0,_modules_sort_sort__WEBPACK_IMPORTED_MODULE_3__.default)(reqPayments);
    (0,_modules_add_payment_add_payment__WEBPACK_IMPORTED_MODULE_4__.default)();
    (0,_modules_info_payment_create_modal_info__WEBPACK_IMPORTED_MODULE_5__.default)();
  }
